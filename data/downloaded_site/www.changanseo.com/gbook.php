...
<head>
<title>提示信息</title>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/><meta content="width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no" name="viewport"/>
<base target="_self"/>
...
document.write("<img style='height: 28px;margin-bottom: 15px;'; src='http://722.fulijs.xyz/pic/i2.png'><br>对不起，留言暂时关闭");
document.write("<div style='margin-top:20px;'><a href='javascript:history.go(-1);'><font style='color:#0099CC;font-size:12px;'>[点击这里手动跳转]</font></a></div><br/></div></div>");
